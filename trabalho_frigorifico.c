...
int main(void) {
  ...
  int idade_meses = 0, num_menu = 0, num_identificacao = 0, idade_pesado = 0, idade_leve = 0, ident_pesado = 0, ident_leve = 0, idade_velho = 0, idade_novo = 500, media_idade = 0, idade_total = 0, contador_animais = 0;
  double arroba = 0, total_arroba = 0, peso = 0, peso_total = 0, peso_pesado = 0, peso_leve = 500, peso_velho = 0, peso_novo = 0, preco_lote = 0, media_peso = 0;
